...
Imamo torej seznam prepovedanih sprememb -- \emph{tabuje} in na vsakem koraku za izbrano
...
spremembo (npr. zamenjava $\text{srečanja}_i \text{in srečanja}_j$) sedaj shranimo v
